...
public class eventOfBrowser extends TestBase {
...
//            e.printStackTrace();
	...
	// To highlight which button and field the script is currently clicking or
	// typing in
	public void highlightElement(WebElement element) {
		JavascriptExecutor executor = (JavascriptExecutor) driver;
		executor.executeScript("arguments[0].setAttribute('style', 'background: #ffffe6; border: 2px solid yellow;');",
				element);
	}
	...
	// retrieve WebElement using xpath with different attributes(use to define any
	// WebElements Object)
	...
	// used to force click on element using WebElement with java script(include
	// scroll and wait)
